...
%boundaryvtk% -loadvtk AutoActual -filexml %dirout%/%name%.xml -motiondata %diroutdata% -savevtkdata %dirout2%/MotionFloating -onlytype:floating -savevtkdata %dirout2%/MotionPiston -onlytype:moving -savevtkdata %dirout2%/Box.vtk -onlytype:fixed
if not "%ERRORLEVEL%" == "0" goto fail
