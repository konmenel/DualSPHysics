...
typedef enum{
  ...
  KGC_BonetLok=1,         ///<KGC from Bonet and Lok.
  KGC_Zago=2,             ///<KGC from Zago et al.
  KGC_BonetLokMinusOp=3,  ///<KGC from Bonet and Lok with minus operator in the interior and plus on the free surface.
